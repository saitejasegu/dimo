...
export function Fab() {
  ...
  return (
    <button
      ...
      className="fixed bottom-[calc(3.75rem+env(safe-area-inset-bottom,0px))] right-5 z-[15] flex h-[54px] w-[54px] items-center justify-center rounded-[18px] !bg-green !text-white shadow-[0_12px_28px_-8px_rgba(31,157,99,0.6)]"
    >
      <PlusIcon />
    </button>
  );
