...
export const categoryOperationValidator = v.object({
  ...typedOpMeta,
  name: v.string(),
  emoji: v.optional(v.string()),
  monthlyBudgetMinor: v.union(v.number(), v.null()),
...
export const transactionOperationValidator = v.object({
  ...typedOpMeta,
  name: v.string(),
  amountMinor: v.number(),
  occurredAt: v.number(),
...
export const recurringOperationValidator = v.object({
  ...typedOpMeta,
  name: v.string(),
  amountMinor: v.number(),
  categoryId: v.string(),
...
export const lendOperationValidator = v.object({
  ...typedOpMeta,
  contactName: v.string(),
  contactId: v.optional(v.string()),
  amountMinor: v.number(),
...
export const preferencesOperationValidator = v.object({
  ...typedOpMeta,
  profileName: v.string(),
  profileEmail: v.string(),
  currency: v.union(v.literal("INR"), v.literal("USD"), v.literal("EUR")),
...
export const TYPED_TABLE_BY_ENTITY: Record<
  EntityTypeName,
  | "categories"
  | "paymentMethods"
  | "transactions"
